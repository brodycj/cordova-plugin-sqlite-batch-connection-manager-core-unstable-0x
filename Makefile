...
SQLITE_BATCH_CONNECTION_CORE_COMMIT_ID := \
	7080c6f9cb916be23d46f9c1db7eaee8ed5eec95
...
build-dist-dependencies:
	...
	cp $(SQLITE_BATCH_CONNECTION_CORE_ROOT)/object-batch-connection/android/io/sqlc/SQLiteBatchCore.java dist-dependencies
	cp $(SQLITE_BATCH_CONNECTION_CORE_ROOT)/sqlite-connection-core.[hc] dist-dependencies
	cp $(SQLITE_BATCH_CONNECTION_CORE_ROOT)/object-batch-connection/ios/SQLiteBatchCore.[hm] dist-dependencies
